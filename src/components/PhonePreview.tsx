...
export default function PhonePreview({
  ...
  return (
    <aside className="mx-auto h-fit w-full max-w-[410px] self-start rounded-[2.5rem] border border-slate-200 bg-slate-950 p-3 shadow-[0_28px_90px_rgba(2,6,23,0.25)] lg:sticky lg:top-6">
      <div className="flex h-[720px] max-h-[calc(100vh-82px)] min-h-[560px] overflow-hidden rounded-[2rem] bg-white">
